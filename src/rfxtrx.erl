...
parse_buffer(<<20,1,_,_,_,_Connected_device,Firmwareversion,_Decodeflag1,_Decodeflag2,_Decodeflag3,_,_,_,_,_Rest/binary>>) -> 
        io:format("Message 1 status, Firmware=~p~n",[Firmwareversion]), <<>>;
